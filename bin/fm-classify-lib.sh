...
# origin gate, and bin/fm-teardown.sh's finished-worker stop at a dirty-copy
# refusal (bin/fm-fleet-snapshot.sh clears on the reconciled crew state
# instead, which already covers this terminal read).
